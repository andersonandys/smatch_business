...
class RegisterIndependentView extends StatefulWidget {
  const RegisterIndependentView({super.key});

  @override
  State<RegisterIndependentView> createState() =>
      _RegisterIndependentViewState();
}

class _RegisterIndependentViewState extends State<RegisterIndependentView> {
                  ...
                  Container(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            "Je m'inscris en tant qu'indépendant",
